...
public class SnowFlakeGenerator {
     ...
     * 作者写代码时的时间戳
     */
    private final static long START_STAMP = 1542009760000L;
    ...
    public synchronized long nextId() {
        ...
        if (currentStamp == lastStamp) {
            ...
            if (sequence == 0L) { //Twitter源代码中的逻辑是循环，直到下一个毫秒
    ...
    public static void main(String[] args) {
        SnowFlakeGenerator snowFlakeGenerator = new SnowFlakeGenerator.Factory().create(12345,12345);
